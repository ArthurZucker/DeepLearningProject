...
class DinowTwins(LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        # Scheduler takes a step at each iteration
    ...
    def configure_optimizers(self):
        ...
        #   optimizer, warmup_epochs=10, max_epochs=self.optim_param.max_epochs,warmup_start_lr=0.1*(self.optim_param.lr * self.trainer.datamodule.batch_size / 256)
        # )
    ...
    def _get_bt_head(self):
        ...
        for i in range(self.proj_layers_num - 2):
            ...
            proj_layers.append(nn.GELU())
        # last layer
        proj_layers.append(nn.Linear(self.proj_channels, self.out_channels, bias=False))
        return nn.Sequential(*proj_layers)
